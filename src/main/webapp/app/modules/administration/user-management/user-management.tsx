      ...
      <h2 id="user-management-page-heading" data-cy="UserManagementHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="new" className="btn btn-primary jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon={faPlus} /> Crear un nuevo usuario
          </Link>
        </div>
      </h2>
        ...
        <thead>
          <tr>
            ...
            <th className="hand" onClick={sort('createdDate')}>
              Fecha de creación <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
            </th>
            <th className="hand" onClick={sort('lastModifiedBy')}>
              Modificado por <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedBy')} />
            </th>
            <th id="modified-date-sort" className="hand" onClick={sort('lastModifiedDate')}>
              Fecha de modificación <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedDate')} />
            </th>
            <th />
          </tr>
        </thead>
