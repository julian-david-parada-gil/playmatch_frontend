...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './partido.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTIDO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARTIDO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARTIDO actions', async () => {
      const arg = { id: '4f10bf26-83ff-4341-ae6a-b65ad78f3c21' };
    ...
    it('dispatches UPDATE_PARTIDO actions', async () => {
      const arg = { id: '4f10bf26-83ff-4341-ae6a-b65ad78f3c21' };
    ...
    it('dispatches PARTIAL_UPDATE_PARTIDO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PARTIDO actions', async () => {
      const arg = 42666;
