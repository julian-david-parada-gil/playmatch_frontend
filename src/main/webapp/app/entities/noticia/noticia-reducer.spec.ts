...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './noticia.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTICIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTICIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTICIA actions', async () => {
      const arg = { id: '2dfbe5db-3ab8-4688-9f90-7a43e6733d5a' };
    ...
    it('dispatches UPDATE_NOTICIA actions', async () => {
      const arg = { id: '2dfbe5db-3ab8-4688-9f90-7a43e6733d5a' };
    ...
    it('dispatches PARTIAL_UPDATE_NOTICIA actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_NOTICIA actions', async () => {
      const arg = 42666;
