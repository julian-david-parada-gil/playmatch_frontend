...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLAPOSICION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TABLAPOSICION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TABLAPOSICION actions', async () => {
      const arg = { id: '62145a00-3508-4930-a203-d5500d8d3dac' };
    ...
    it('dispatches UPDATE_TABLAPOSICION actions', async () => {
      const arg = { id: '62145a00-3508-4930-a203-d5500d8d3dac' };
    ...
    it('dispatches PARTIAL_UPDATE_TABLAPOSICION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_TABLAPOSICION actions', async () => {
      const arg = 42666;
