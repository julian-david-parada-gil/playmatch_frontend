...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './torneo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TORNEO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TORNEO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TORNEO actions', async () => {
      const arg = { id: '40d63edd-7522-4d68-b4d6-fc7259d16d3d' };
    ...
    it('dispatches UPDATE_TORNEO actions', async () => {
      const arg = { id: '40d63edd-7522-4d68-b4d6-fc7259d16d3d' };
    ...
    it('dispatches PARTIAL_UPDATE_TORNEO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_TORNEO actions', async () => {
      const arg = 42666;
