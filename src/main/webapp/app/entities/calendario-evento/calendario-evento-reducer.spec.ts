...
import reducer, {
  ...
  reset,
  updateEntity,
} from './calendario-evento.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALENDARIOEVENTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CALENDARIOEVENTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CALENDARIOEVENTO actions', async () => {
      const arg = { id: 'f4685dff-716b-4bf2-9f56-438d16bd7324' };
    ...
    it('dispatches UPDATE_CALENDARIOEVENTO actions', async () => {
      const arg = { id: 'f4685dff-716b-4bf2-9f56-438d16bd7324' };
    ...
    it('dispatches PARTIAL_UPDATE_CALENDARIOEVENTO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CALENDARIOEVENTO actions', async () => {
      const arg = 42666;
