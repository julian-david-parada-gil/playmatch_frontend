...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONVOCATORIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONVOCATORIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONVOCATORIA actions', async () => {
      const arg = { id: 'cccefc53-c0cb-4ef4-b5e9-eb688974ac93' };
    ...
    it('dispatches UPDATE_CONVOCATORIA actions', async () => {
      const arg = { id: 'cccefc53-c0cb-4ef4-b5e9-eb688974ac93' };
    ...
    it('dispatches PARTIAL_UPDATE_CONVOCATORIA actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CONVOCATORIA actions', async () => {
      const arg = 42666;
