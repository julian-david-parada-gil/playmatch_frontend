...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALIFICACION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CALIFICACION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CALIFICACION actions', async () => {
      const arg = { id: 'f70b8935-bc54-4466-a147-ab60ec4c120f' };
    ...
    it('dispatches UPDATE_CALIFICACION actions', async () => {
      const arg = { id: 'f70b8935-bc54-4466-a147-ab60ec4c120f' };
    ...
    it('dispatches PARTIAL_UPDATE_CALIFICACION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CALIFICACION actions', async () => {
      const arg = 42666;
