...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENSAJEGRUPO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MENSAJEGRUPO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MENSAJEGRUPO actions', async () => {
      const arg = { id: '574eb390-6ced-41f7-bf99-f6f912ac17d3' };
    ...
    it('dispatches UPDATE_MENSAJEGRUPO actions', async () => {
      const arg = { id: '574eb390-6ced-41f7-bf99-f6f912ac17d3' };
    ...
    it('dispatches PARTIAL_UPDATE_MENSAJEGRUPO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MENSAJEGRUPO actions', async () => {
      const arg = 42666;
