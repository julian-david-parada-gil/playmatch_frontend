          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('modalidad')}>
                  Modalidad <FontAwesomeIcon icon={getSortIconByFieldName('modalidad')} />
                </th>
                <th className="hand" onClick={sort('descripcion')}>
                  Descripcion <FontAwesomeIcon icon={getSortIconByFieldName('descripcion')} />
                </th>
                <th className="hand" onClick={sort('fechaCreacion')}>
                  Fecha Creacion <FontAwesomeIcon icon={getSortIconByFieldName('fechaCreacion')} />
                </th>
            ...
            <tbody>
              {categoriaList.map(categoria => (
                <tr key={`entity-${categoria.id}`} data-cy="entityTable">
                  ...
                  <td>{categoria.modalidad}</td>
                  <td>{categoria.descripcion}</td>
                  <td>
                    {categoria.fechaCreacion ? <TextFormat type="date" value={categoria.fechaCreacion} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {categoria.fechaActualizacion ? (
                      <TextFormat type="date" value={categoria.fechaActualizacion} format={APP_DATE_FORMAT} />
                    ) : null}
                  </td>
