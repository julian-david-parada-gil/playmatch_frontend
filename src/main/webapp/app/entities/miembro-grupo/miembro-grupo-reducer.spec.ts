...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MIEMBROGRUPO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MIEMBROGRUPO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MIEMBROGRUPO actions', async () => {
      const arg = { id: 'd1ae29f6-c789-4ba7-9a61-c431c95ea4cb' };
    ...
    it('dispatches UPDATE_MIEMBROGRUPO actions', async () => {
      const arg = { id: 'd1ae29f6-c789-4ba7-9a61-c431c95ea4cb' };
    ...
    it('dispatches PARTIAL_UPDATE_MIEMBROGRUPO actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MIEMBROGRUPO actions', async () => {
      const arg = 42666;
