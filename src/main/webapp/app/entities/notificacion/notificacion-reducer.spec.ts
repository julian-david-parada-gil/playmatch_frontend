...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICACION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTIFICACION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTIFICACION actions', async () => {
      const arg = { id: '2edac240-ad7a-456a-b25e-ee3a8dc2973c' };
    ...
    it('dispatches UPDATE_NOTIFICACION actions', async () => {
      const arg = { id: '2edac240-ad7a-456a-b25e-ee3a8dc2973c' };
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICACION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_NOTIFICACION actions', async () => {
      const arg = 42666;
