...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSCRIPCION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSCRIPCION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSCRIPCION actions', async () => {
      const arg = { id: '19f39ede-6529-4e38-a2d4-70a3c7eaecee' };
    ...
    it('dispatches UPDATE_INSCRIPCION actions', async () => {
      const arg = { id: '19f39ede-6529-4e38-a2d4-70a3c7eaecee' };
    ...
    it('dispatches PARTIAL_UPDATE_INSCRIPCION actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_INSCRIPCION actions', async () => {
      const arg = 42666;
